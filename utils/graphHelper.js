...
function getTodayMeeting(accessToken, callback) {



  request
    .get(
      "https://graph.microsoft.com/v1.0//me/calendar/calendarView?startDateTime=2018-06-08T01:00:00.0000000&endDateTime=2018-06-20T00:00:00.0000000"
    )
    .set("Authorization", "Bearer " + accessToken)
    .end((err, res) => {
...
exports.getTodayMeeting = getTodayMeeting;
